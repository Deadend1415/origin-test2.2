...
$db_name = "test";
  ...
  $query = "select id_utente,username,password,email
            from tbl_test4;";
 ...
 if (!$output) {
  ...
  if($o[1] != $username or $o[2] != $password) {
    exit("Error");
  }else{
    ...
    $id_utente = $o[0];
    $emailto = $o[3];
    echo "id_utente: " . $id_utente ."<br>" . "emailto: " . $emailto . "<br>";

      $query2 = "UPDATE tbl_test4 SET 2FA = $fa, 2FA_EXPIRE = ADDTIME(CURRENT_TIMESTAMP,900) 
